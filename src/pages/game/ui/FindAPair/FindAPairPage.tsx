...
export function FindAPairPage() {
  ...
  const isComplete = useProgressStore((state) =>
    state.completedGameIds.includes('find-a-pair'),
  )
    ...
    <main className="beach-shell">
      ...
      <section className="game-layout">
        <div className="game-panel">
          ...
          <p>
            Найди все пары карт с одинаковым значением.
            Масть значения не имеет.
          </p>

          <FindAPair
            onWin={() => setCompleted(true)}
            onLoss={() => setCompleted(false)}
          />
        </div>
        ...
        <aside className="info-panel">
          ...
          <p>
            Найди все <strong>12 пар</strong> на поле
            6×4 карт.
          </p>
          ...
          {isComplete && (
            <p className="find-a-pair-page__completed">
              Все пары найдены! 🎉
            </p>
          )}
        </aside>
