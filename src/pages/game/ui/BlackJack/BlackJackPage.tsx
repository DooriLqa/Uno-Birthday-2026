...
export function BlackJackPage() {
  ...
  const isComplete = useProgressStore((state) =>
    state.completedGameIds.includes('black-jack'),
  )
  ...
  const handleWin = () => {
    setWinStreak((current) =>
      Math.min(current + 1, REQUIRED_WINS),
    )
  }
    ...
    <main className="beach-shell">
      ...
      <section className="game-layout">
        <div className="game-panel">
          ...
          <p>
            Набери как можно ближе к 21 очку и опереди
            раздающего, не превысив 21.
          </p>
        ...
        <aside className="info-panel">
          ...
          <p>
            Победи раздающего <strong>5 раз подряд</strong>,
            чтобы пройти игру.
          </p>

          <p>
            Если проиграешь раунд, серия побед начинается
            заново с 0/5.
          </p>
          ...
          {isComplete && (
            <p className="black-jack-page__completed">
              Победа засчитана! 🎉
            </p>
          )}
        </aside>
