    ...
    <main className="sea-battle-page">
      ...
      <section className="sea-battle-page__task" aria-label="Задание и управление">
        ...
        <div className="sea-battle-page__task-grid">
          <p>
            <strong>A / ←</strong> — переместить прицел влево.
          </p>
          <p>
            <strong>D / →</strong> — переместить прицел вправо.
          </p>
          <p>
            <strong>Пробел</strong> — выстрелить.
          </p>
          <p>
            <strong>ЛКМ</strong> — выстрелить.
          </p>
          <p>
            <strong>10 торпед</strong> — один выстрел раз в 3 секунды.
          </p>
          <p>
            <strong>5 попаданий</strong> — победа.
          </p>
        </div>
      </section>
