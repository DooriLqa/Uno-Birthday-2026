import tropicalIslandMap from '@/shared/assets/features/island-map/tropical-island-map-expanded.png'
    ...
    >
      ...
      >
        <img
          ...
          alt="Карта острова: туристический пляж, дикий пляж и джунгли"
        />
        {worldRegions.map((region) => (
          <button
            key={region.id}
            type="button"
            className="game-island-map__region"
            style={region.area}
          ...
          >
            <span>
              {region.title}
              {!region.entry && <small>Пока недоступна</small>}
            </span>
          </button>
        ))}
      </div>
