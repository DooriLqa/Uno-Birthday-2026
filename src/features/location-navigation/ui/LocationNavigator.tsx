...
import ritualSiteExtinguished from '@/shared/assets/locations/wild/ritual-site-extinguished-v6.png'
import ritualSiteLit from '@/shared/assets/locations/wild/ritual-site-lit-v6.png'
