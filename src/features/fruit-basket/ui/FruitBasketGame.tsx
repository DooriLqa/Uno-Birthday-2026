  ...
  return (
    <div className="fruit-basket-game">
      ...
      <div className="fruit-basket-game__field" aria-label="Игровое поле">
        <div
          className={`fruit-basket-game__drop-zone fruit-basket-game__drop-zone--left ${basketDropZoneClass(game, 'left')}`}
        >
          <strong>СДАТЬ</strong>
          <span>←</span>
        ...
        <div
          className={`fruit-basket-game__drop-zone fruit-basket-game__drop-zone--right ${basketDropZoneClass(game, 'right')}`}
        >
          <strong>СДАТЬ</strong>
          <span>→</span>
          <i style={{ height: `${dropProgressPercent(game, 'right')}%` }} />
        </div>
        <div className="fruit-basket-game__sun" aria-hidden="true">
          ☀
        </div>
        <div className="fruit-basket-game__cloud cloud-one" aria-hidden="true">
          ☁
        </div>
        <div className="fruit-basket-game__cloud cloud-two" aria-hidden="true">
          ☁
        </div>
        {game.items.map((item) => (
          <span
