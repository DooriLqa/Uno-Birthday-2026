...
export function WackAMole({ onWin, onLoss }: WackAMoleProps) {
  ...
  return (
    <div className="wack-a-mole">
      <div className="wack-a-mole__hud">
        ...
        {result === 'win' && (
          <div className="wack-a-mole__result wack-a-mole__result--win">
            Попал! 🎯
          </div>
        )}

        {result === 'lose' && (
          <div className="wack-a-mole__result wack-a-mole__result--lose">
            Время вышло!
          </div>
        )}
      </div>
        ...
        {BUSHES.map((index) => (
          ...
          >
            <img
              ...
              alt=""
              draggable={false}
              className="wack-a-mole__bush-image"
            />
